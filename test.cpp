...
void TestAddToOpen() {
  ...
  vector<vector<State>> grid{{State::kSearched, State::kObstacle, State::kEmpty, State::kEmpty, State::kEmpty, State::kEmpty},
                            {State::kSearched, State::kObstacle, State::kEmpty, State::kEmpty, State::kEmpty, State::kEmpty},
                            {State::kSearched, State::kObstacle, State::kEmpty, State::kEmpty, State::kEmpty, State::kEmpty},
  ...
  solution_grid[3][0] = State::kSearched;
...
void TestSearch() {
  ...
  vector<vector<State>> solution{{State::kPath, State::kObstacle, State::kEmpty, State::kEmpty, State::kEmpty, State::kEmpty},
                            ...
                            {State::kPath, State::kObstacle, State::kEmpty, State::kSearched, State::kSearched, State::kSearched},
                            {State::kPath, State::kObstacle, State::kSearched, State::kPath, State::kPath, State::kPath},
...
void TestCheckValidCell() {
  ...
  vector<vector<State>> grid{{State::kSearched, State::kObstacle, State::kEmpty, State::kEmpty, State::kEmpty, State::kEmpty},
                            ...
                            {State::kSearched, State::kObstacle, State::kEmpty, State::kEmpty, State::kEmpty, State::kEmpty},
                            {State::kSearched, State::kObstacle, State::kEmpty, State::kEmpty, State::kEmpty, State::kEmpty},
                            {State::kSearched, State::kSearched, State::kEmpty, State::kEmpty, State::kObstacle, State::kEmpty}};
...
void TestExpandNeighbors() {
  ...
  vector<vector<State>> grid{{State::kSearched, State::kObstacle, State::kEmpty, State::kEmpty, State::kEmpty, State::kEmpty},
                            ...
                            {State::kSearched, State::kSearched, State::kEmpty, State::kEmpty, State::kObstacle, State::kEmpty}};
  vector<vector<State>> solution_grid = grid;
  solution_grid[3][2] = State::kSearched;
  solution_grid[4][3] = State::kSearched;
